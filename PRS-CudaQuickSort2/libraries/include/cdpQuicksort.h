...
//float run_quicksort_cdp2(unsigned *gpudata, unsigned *scratchdata, unsigned int count, cudaStream_t stream);
////////////////////////////////////////////
...
__global__ void qsort_warp(unsigned *indata, unsigned *outdata, unsigned int offset, unsigned int len, qsortAtomicData *atomicData, qsortRingbuf *ringbuf, unsigned int source_is_indata, unsigned int depth);
